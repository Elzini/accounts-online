...
const ALL_SEARCH_ITEMS: SearchItem[] = [
  ...
  { id: 'trial-balance', label: 'ميزان المراجعة', labelEn: 'Trial Balance', section: 'المحاسبة', sectionEn: 'Accounting', icon: 'Scale', keywords: ['ميزان', 'مراجعة', 'trial balance', 'شامل', 'comprehensive'] },
