...
import { useSensitiveOpsLog } from '@/hooks/modules/useControlCenterServices';
...
export function CompanySensitiveOpsLog() {
      ...
      <CardContent className="space-y-4">
        ...
        <ScrollArea className="h-[450px]">
          {isLoading ? (
            ...
            <div className="text-center py-8 text-muted-foreground">لا توجد عمليات حساسة مسجلة</div>
          ) : (
