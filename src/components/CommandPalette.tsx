...
const COMMAND_ITEMS: CommandItemData[] = [
  ...
  { id: 'trial-balance-analysis', label: 'ميزان المراجعة', labelEn: 'Trial Balance', icon: FileSpreadsheet, group: 'المحاسبة', keywords: 'ميزان مراجعة trial balance' },
  { id: 'comprehensive-trial-balance', label: 'ميزان المراجعة الشامل', labelEn: 'Comprehensive Trial Balance', icon: Scale, group: 'المحاسبة', keywords: 'ميزان شامل comprehensive' },
