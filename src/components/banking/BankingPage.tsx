/**
 * Banking Page - Orchestrator (Decomposed)
 * Previously 824 lines → now thin orchestrator + hook + sub-components
 */
import { useState, useMemo } from 'react';
import { Building2, Upload, Scale, Eye, Loader2, CheckCircle, XCircle, Edit, Trash2, Brain, FileText, Table2, Search, ChevronsUpDown, Check } from 'lucide-react';
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <Tabs defaultValue="accounts">
        ...
        <TabsContent value="accounts" className="mt-4">
          <BankAccountsTab ctx={ctx} />
        </TabsContent>

        <TabsContent value="statements" className="mt-4">
          <BankStatementsTab ctx={ctx} />
        </TabsContent>

        <TabsContent value="reconciliations" className="mt-4">
          <BankReconciliationsTab ctx={ctx} />
        </TabsContent>
      </Tabs>
...
function BankAccountsTab({ ctx }: { ctx: ReturnType<typeof useBankingPage> }) {
...
function BankStatementsTab({ ctx }: { ctx: ReturnType<typeof useBankingPage> }) {
...
function BankReconciliationsTab({ ctx }: { ctx: ReturnType<typeof useBankingPage> }) {
...
function AddAccountDialog({ ctx }: { ctx: ReturnType<typeof useBankingPage> }) {
...
function ImportStatementDialog({ ctx }: { ctx: ReturnType<typeof useBankingPage> }) {
...
function ReconciliationDialog({ ctx }: { ctx: ReturnType<typeof useBankingPage> }) {
...
function EditStatementDialog({ ctx }: { ctx: ReturnType<typeof useBankingPage> }) {
...
function DeleteStatementDialog({ ctx }: { ctx: ReturnType<typeof useBankingPage> }) {
...
function EditAccountDialog({ ctx }: { ctx: ReturnType<typeof useBankingPage> }) {
...
function DeleteAccountDialog({ ctx }: { ctx: ReturnType<typeof useBankingPage> }) {
...
// ========== Transactions Dialog (kept as-is, already isolated) ==========
