...
import {
  ...
  Calendar, Settings2, Boxes, FileUp, HardHat, Wrench, HandCoins, MapPin, Palette,
...
export function Sidebar({
  ...
  const accountsMenuItems: MenuItem[] = [
    ...
    { id: 'trial-balance' as ActivePage, label: t.nav_trial_balance, icon: Scale },
