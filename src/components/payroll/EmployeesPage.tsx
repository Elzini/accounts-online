    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground">إضافة وتعديل بيانات الموظفين والرواتب الأساسية</p>
        </div>
          ...
          <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="transport_allowance">بدل المواصلات</Label>
                  <Input
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="text-2xl font-bold">
              {formatCurrency(employees.reduce((sum, e) => sum + Number(e.base_salary), 0))}
            </div>
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="text-2xl font-bold">
              {formatCurrency(employees.reduce((sum, e) => 
                sum + Number(e.base_salary) + Number(e.housing_allowance) + Number(e.transport_allowance), 0
              ))}
            </div>
            <p className="text-sm text-muted-foreground">إجمالي مع البدلات</p>
          </CardContent>
        </Card>
      </div>
      ...
      <AlertDialog open={!!deleteId} onOpenChange={() => setDeleteId(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              سيتم حذف بيانات الموظف نهائياً. لا يمكن التراجع عن هذا الإجراء.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
