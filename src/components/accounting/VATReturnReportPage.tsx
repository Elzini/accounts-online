        ...
        <CardContent className="pt-4">
          <Table>
            ...
            <TableBody>
              ...
              {(report?.salesReturns?.count || 0) > 0 && (
                <TableRow className="bg-amber-50 dark:bg-amber-950/30"><TableCell className="font-medium">-</TableCell><TableCell>مرتجعات المبيعات (إشعارات دائنة) <Badge variant="outline" className="mr-2 text-xs">{report?.salesReturns?.count}</Badge></TableCell><TableCell className="text-left font-mono text-amber-600">-{formatNumber(report?.salesReturns?.amount || 0)}</TableCell><TableCell className="text-left font-mono text-amber-600">-{formatNumber(report?.salesReturns?.vat || 0)}</TableCell></TableRow>
              )}
        ...
        <CardContent className="pt-4">
          <Table>
            ...
            <TableBody>
              ...
              <TableRow><TableCell className="font-medium">9</TableCell><TableCell>{t.vat_imports_reverse}</TableCell><TableCell className="text-left font-mono">{formatNumber(report?.purchases.reverseChargeAmount || 0)}</TableCell><TableCell className="text-left font-mono text-rose-600 dark:text-rose-400">{formatNumber(report?.purchases.reverseChargeVAT || 0)}</TableCell></TableRow>
              ...
              {(report?.purchaseReturns?.count || 0) > 0 && (
                <TableRow className="bg-amber-50 dark:bg-amber-950/30"><TableCell className="font-medium">-</TableCell><TableCell>مرتجعات المشتريات (إشعارات مدينة) <Badge variant="outline" className="mr-2 text-xs">{report?.purchaseReturns?.count}</Badge></TableCell><TableCell className="text-left font-mono text-amber-600">-{formatNumber(report?.purchaseReturns?.amount || 0)}</TableCell><TableCell className="text-left font-mono text-amber-600">-{formatNumber(report?.purchaseReturns?.vat || 0)}</TableCell></TableRow>
              )}
