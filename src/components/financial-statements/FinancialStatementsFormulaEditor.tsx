// محرر معادلات القوائم المالية الشاملة
...
export function FinancialStatementsFormulaEditor({ 
  currentValues = {},
  onApplyFormula 
}: FinancialStatementsFormulaEditorProps) {
  ...
  const handleSaveFormula = async () => {
    ...
    await saveFormula.mutateAsync({
      ...
      formula_category: activeCategory,
      ...
      <DialogContent className="max-w-6xl max-h-[90vh] overflow-hidden">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            محرر معادلات القوائم المالية
          </DialogTitle>
          <DialogDescription>
            بناء وتخصيص معادلات حساب القوائم المالية المختلفة
          </DialogDescription>
        </DialogHeader>
                ...
                <div className="grid grid-cols-2 gap-3 p-3 bg-muted/30 rounded-lg">
                  <div className="space-y-1">
                    ...
                    <Input
                      ...
                      placeholder="مثال: إجمالي الموجودات"
                      className="h-8"
                    />
                  </div>
                  <div className="space-y-1">
