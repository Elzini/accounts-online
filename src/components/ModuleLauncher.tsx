  ...
  const modules: MainModule[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'executive-kpis', label: 'لوحة KPIs الإدارية', labelEn: 'Executive KPIs', icon: Target },
        { id: 'commissions-system', label: 'نظام العمولات', labelEn: 'Commissions', icon: Calculator },
        { id: 'branch-comparison', label: 'مقارنة الفروع', labelEn: 'Branch Comparison', icon: Building2 },
        { id: 'ai-sales-forecast', label: 'توقعات AI للمبيعات', labelEn: 'AI Sales Forecast', icon: Sparkles },
