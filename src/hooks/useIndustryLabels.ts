...
function buildLabels(companyType: CompanyActivityType, t: TranslationKeys): Record<CompanyActivityType, IndustryLabels> {
  return {
    ...
    medical: {
      itemName: t.industry_medicine || 'المنتج الطبي',
      itemsName: t.industry_medicines || 'المنتجات الطبية',
      itemUnit: t.industry_medicine_unit || 'منتج',
      availableItems: t.industry_available_medicines || 'المنتجات الطبية المتاحة',
      availableSubtitle: t.industry_medicine_in_stock || 'منتج في المخزون',
      totalPurchasesLabel: t.industry_total_medical_purchases || 'إجمالي المشتريات الطبية',
      allTimePurchasesSubUnit: t.industry_medicine_unit || 'منتج',
      allTimeSalesSubUnit: t.industry_sale_operation,
      inventoryLabel: t.industry_medical_inventory || 'المخزون الطبي',
      inventoryActions: [
        { label: t.industry_medicines || 'المنتجات الطبية', page: 'purchases' },
        { label: t.inventory_report, page: 'inventory-report' },
      ],
      showTransfersReport: false,
      showPartnerReport: false,
    ...
    bookkeeping: {
      ...
      itemsName: 'الخدمات',
      itemUnit: 'خدمة',
      availableItems: 'الخدمات المتاحة',
      availableSubtitle: 'خدمة محاسبية',
      totalPurchasesLabel: 'إجمالي المشتريات',
      allTimePurchasesSubUnit: 'عملية',
      allTimeSalesSubUnit: t.industry_sale_operation,
      inventoryLabel: 'الخدمات',
      inventoryActions: [],
      showTransfersReport: false,
      showPartnerReport: false,
      showCommissionsReport: false,
    ...
    manufacturing: {
      ...
      totalPurchasesLabel: 'إجمالي مشتريات المواد الخام',
      allTimePurchasesSubUnit: 'مادة',
      allTimeSalesSubUnit: t.industry_sale_operation,
      inventoryLabel: 'مخزون المصنع',
      inventoryActions: [
        { label: 'المنتجات', page: 'purchases' },
        { label: t.inventory_report, page: 'inventory-report' },
      ],
      showTransfersReport: false,
      showPartnerReport: false,
