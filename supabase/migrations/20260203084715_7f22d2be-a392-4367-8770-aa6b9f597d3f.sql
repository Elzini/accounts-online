-- إعادة إنشاء الدالة بدون session_replication_role
DROP FUNCTION IF EXISTS public.fix_missing_cogs_entries();
...
GRANT EXECUTE ON FUNCTION public.fix_missing_cogs_entries() TO authenticated;