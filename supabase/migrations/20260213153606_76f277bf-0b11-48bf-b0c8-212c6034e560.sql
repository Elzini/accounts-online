-- Recreate bank_accounts_safe view with security_invoker to inherit RLS from bank_accounts
...
-- Grant access to authenticated users (RLS on base table enforces admin-only)
