...
-- Update create_default_accounts to have consistent code lengths and add COGS category
...
BEGIN
  ...
  (p_company_id, '1205', 'أرباح مستحقة', 'assets', false, v_receivables_id, 'أرباح مستحقة التحصيل');
  ...
  INSERT INTO account_categories (company_id, code, name, type, is_system, parent_id, description)
  VALUES (p_company_id, '31', 'رأس المال والاحتياطيات', 'equity', true, v_equity_id, 'رأس المال وحقوق الملاك')
  ...
  (p_company_id, '3103', 'الأرباح المحتجزة', 'equity', true, v_capital_id, 'أرباح محتجزة من سنوات سابقة'),
  (p_company_id, '3104', 'أرباح / خسائر العام', 'equity', true, v_capital_id, 'نتيجة العام الحالي');
  ...
  -- ==================== 5 تكلفة المبيعات ====================
  INSERT INTO account_categories (company_id, code, name, type, is_system, parent_id, description)
  VALUES (p_company_id, '5', 'تكلفة المبيعات', 'expenses', true, null, 'تكلفة البضاعة المباعة')
  RETURNING id INTO v_cogs_root_id;

  INSERT INTO account_categories (company_id, code, name, type, is_system, parent_id, description)
  VALUES (p_company_id, '51', 'تكلفة البضاعة المباعة', 'expenses', true, v_cogs_root_id, 'تكلفة السيارات المباعة')
  ...
  INSERT INTO account_categories (company_id, code, name, type, is_system, parent_id, description)
  VALUES (p_company_id, '6', 'المصروفات التشغيلية', 'expenses', true, null, 'إجمالي مصروفات الشركة')
  RETURNING id INTO v_expenses_id;

  INSERT INTO account_categories (company_id, code, name, type, is_system, parent_id, description)
  VALUES (p_company_id, '61', 'المصروفات الإدارية', 'expenses', false, v_expenses_id, 'مصاريف إدارية وعمومية')
  RETURNING id INTO v_admin_exp_id;

  INSERT INTO account_categories (company_id, code, name, type, is_system, parent_id, description) VALUES
  (p_company_id, '6101', 'الرواتب والأجور', 'expenses', false, v_admin_exp_id, 'رواتب وأجور الموظفين'),
  (p_company_id, '6102', 'الإيجارات', 'expenses', false, v_admin_exp_id, 'إيجار المعرض والمكاتب'),
  (p_company_id, '6103', 'الكهرباء والماء', 'expenses', false, v_admin_exp_id, 'فواتير خدمات'),
  (p_company_id, '6104', 'الاتصالات والإنترنت', 'expenses', false, v_admin_exp_id, 'فواتير اتصالات'),
  (p_company_id, '6105', 'مصاريف حكومية ورسوم', 'expenses', false, v_admin_exp_id, 'رسوم حكومية وتراخيص'),
  (p_company_id, '6106', 'مصاريف بنكية', 'expenses', false, v_admin_exp_id, 'عمولات ورسوم بنكية'),
  (p_company_id, '6107', 'مصاريف التأمين', 'expenses', false, v_admin_exp_id, 'أقساط تأمين'),
  (p_company_id, '6108', 'الصيانة والنظافة', 'expenses', false, v_admin_exp_id, 'مصاريف صيانة ونظافة'),
  (p_company_id, '6109', 'مصاريف إدارية أخرى', 'expenses', false, v_admin_exp_id, 'مصاريف إدارية متنوعة');

  INSERT INTO account_categories (company_id, code, name, type, is_system, parent_id, description)
  VALUES (p_company_id, '62', 'مصاريف البيع والتسويق', 'expenses', false, v_expenses_id, 'مصاريف متعلقة بالمبيعات')
  RETURNING id INTO v_sales_exp_id;

  INSERT INTO account_categories (company_id, code, name, type, is_system, parent_id, description) VALUES
  (p_company_id, '6201', 'عمولات المبيعات', 'expenses', false, v_sales_exp_id, 'عمولات بيع للموظفين'),
  (p_company_id, '6202', 'الإعلان والتسويق', 'expenses', false, v_sales_exp_id, 'مصاريف دعاية وإعلان'),
  (p_company_id, '6203', 'مصاريف نقل السيارات', 'expenses', false, v_sales_exp_id, 'شحن ونقل السيارات');

  INSERT INTO account_categories (company_id, code, name, type, is_system, parent_id, description)
  VALUES (p_company_id, '63', 'مصاريف أخرى', 'expenses', false, v_expenses_id, 'مصاريف غير مصنفة')
  RETURNING id INTO v_other_exp_id;

  INSERT INTO account_categories (company_id, code, name, type, is_system, parent_id, description) VALUES
  (p_company_id, '6301', 'مصاريف متنوعة', 'expenses', false, v_other_exp_id, 'مصاريف أخرى'),
  (p_company_id, '6302', 'إهلاك الأصول الثابتة', 'expenses', false, v_other_exp_id, 'مصروف إهلاك سنوي'),
  (p_company_id, '6303', 'خسائر بيع أصول', 'expenses', false, v_other_exp_id, 'خسائر ناتجة عن بيع أصول');
