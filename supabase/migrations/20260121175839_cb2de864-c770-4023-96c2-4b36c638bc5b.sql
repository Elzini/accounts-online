-- Update the sale journal entry function to use new cars account (4101) instead of used cars (4102)
...
BEGIN
  ...
  -- Use new cars account (4101) instead of used cars (4102)
  ...
  -- Credit: Sales Revenue - New Cars (base amount without tax)
  INSERT INTO journal_entry_lines (journal_entry_id, account_id, description, debit, credit)
  VALUES (v_entry_id, v_sales_revenue_account_id, 'إيراد مبيعات سيارات جديدة', 0, v_net_sale);
