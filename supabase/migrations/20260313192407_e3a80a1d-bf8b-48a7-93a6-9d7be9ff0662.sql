...
-- تحديث دالة إنشاء شجرة حسابات التطوير العقاري المحسّنة
-- بناءً على ملف العميل مع التصحيحات: حذف القسم 7000 المكرر + إضافة مخصص الزكاة + مكافأة نهاية الخدمة + تفصيل الإهلاك
...
BEGIN
  ...
  -- حسابات فردية تحت الأصول المتداولة
  INSERT INTO account_categories (company_id, code, name, type, is_system, parent_id, description) VALUES
  ...
  INSERT INTO account_categories (company_id, code, name, type, is_system, parent_id, description)
  VALUES (p_company_id, '1180', 'ضريبة قيمة مضافة قابلة للاسترداد', 'assets', true, v_current_assets_id, 'ضريبة المدخلات القابلة للاسترداد')
  RETURNING id INTO v_vat_input_id;

  INSERT INTO account_categories (company_id, code, name, type, is_system, parent_id, description) VALUES
  (p_company_id, '1181', 'ضريبة مدخلات مشاريع', 'assets', true, v_vat_input_id, 'ضريبة مدخلات على تكاليف المشاريع'),
  ...
  -- 1220 مشاريع تحت التطوير (تفصيل كامل لمراحل البناء)
  INSERT INTO account_categories (company_id, code, name, type, is_system, parent_id, description)
  ...
  -- حسابات أخرى تحت مشاريع تحت التطوير
  INSERT INTO account_categories (company_id, code, name, type, is_system, parent_id, description) VALUES
  ...
  -- حسابات أخرى تحت الخصوم المتداولة
  INSERT INTO account_categories (company_id, code, name, type, is_system, parent_id, description) VALUES
  ...
  (p_company_id, '2150', 'ضريبة القيمة المضافة المستحقة', 'liabilities', true, v_current_liab_id, 'ضريبة مخرجات مستحقة لـ ZATCA'),
  ...
  -- ملاحظة: تم حذف القسم 7000 (حسابات المشاريع) لأنه مكرر مع القسم 1220 (مشاريع تحت التطوير)
  -- التكاليف تُسجل في المخزون العقاري (1200) وعند البيع تُحوّل إلى تكلفة المبيعات (5000)
END;
$function$;
