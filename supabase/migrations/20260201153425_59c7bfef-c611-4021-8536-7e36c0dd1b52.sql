-- Update the expense journal entry trigger to handle prepaid expense amortization correctly
-- When payment_method is 'prepaid', credit should go to Prepaid Expenses (1304) not Cash (1101)
