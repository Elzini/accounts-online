...
4. المبالغ: استخرج المبالغ كأرقام بدون رموز عملات. لا تقرب الأرقام أبداً - استخرجها كما هي بالضبط من الفاتورة بجميع الكسور العشرية (هللات). مثال: 43.48 تبقى 43.48 وليس 43 أو 43.5.
5. بنود الفاتورة: استخرج كل بند بدقة مع الكمية وسعر الوحدة والإجمالي. الأرقام يجب أن تكون مطابقة تماماً لما في الفاتورة.
...
11. دقة الأرقام: جميع المبالغ يجب أن تحتفظ بكامل الكسور العشرية. لا تقم بتقريب أي رقم.

⚠️ تعليمات حاسمة لاسم المورد (supplier_name):
- يجب أن يكون **اسم المورد القانوني المرتبط بالرقم الضريبي والعنوان** الموجود في الفاتورة (الكيان المُصدِر للفاتورة).
- إذا ظهر في الفاتورة اسمان: اسم تجاري للمحطة/الفرع (مثل "محطة الحقل الأسود") واسم الشركة الأم/المالكة (مثل "شركة بترولنا العربية للوقود")، فاختر **اسم الشركة المالكة المرتبط بالرقم الضريبي**.
- تحقق دائماً: الرقم الضريبي والعنوان والاسم يجب أن تخص **نفس الكيان القانوني**.
- إذا كان اسم الفرع/المحطة مختلفاً عن اسم الشركة المالكة، ضعه في حقل "supplier_branch_name" منفصلاً، ولا تخلط بينهما في supplier_name.
- لا تخترع أسماء غير موجودة في الفاتورة. الاسم يجب أن يكون مطابقاً نصياً لما هو مكتوب فعلاً.
